...
module.exports = {
	checkReqBody(req, res, next) {
		...
		if (!req.body.workspot.type) { req.body.workspot.type = "" }
		if (!req.body.workspot.wifi) { req.body.workspot.wifi = "" }
		if (!req.body.workspot.outlet) { req.body.workspot.outlet = "" }
		if (!req.body.workspot.parking) { req.body.workspot.parking = "" }
		if (!req.body.workspot.food) { req.body.workspot.food = "" }
